...
namespace Celeste.Mod.UI
{
    ...
    public class OuiModOptionStringFixed : Oui
    {
        ...
        public OuiModOptionStringFixed()
            : base()
        {
        ...
        public OuiModOptionStringFixed Init<T>(string value, Action<string> onValueChange, int maxValueLength = 12) where T : Oui
        {
